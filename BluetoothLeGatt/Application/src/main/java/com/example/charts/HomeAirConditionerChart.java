...
public class HomeAirConditionerChart extends  MyChart
{
    ...
    public HomeAirConditionerChart(Context context, LinearLayout rl, JSONDevice myJSONdevice, String url, RequestQueue queue)
    {
    ...
    public void InitChart()
    {
        ...
        dataset_highest = new LineDataSet(line_entry,"AirConditioner");
        ...
        chart.getXAxis().setValueFormatter(new LineChartXAxisValueFormatter_HomeAirConditionerChart());
        chart.setData(data);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        Gson gson = new Gson();
                        JSONHomeAirConditioner json = gson.fromJson(response, JSONHomeAirConditioner.class);
                        Date currentTime = Calendar.getInstance().getTime();
                        float currenttime2 = currentTime.getHours()*3600 + currentTime.getMinutes()*60 + currentTime.getSeconds();
...
class LineChartXAxisValueFormatter_HomeAirConditionerChart extends IndexAxisValueFormatter
{
