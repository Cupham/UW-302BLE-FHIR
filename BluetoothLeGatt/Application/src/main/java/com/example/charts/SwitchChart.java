...
import com.example.uichart.ui.json.JSONSwitch;
...
public class SwitchChart extends MyChart
{
    Context context;
    LineChart chart;
    ...
    public SwitchChart(Context context, LinearLayout rl, JSONDevice myJSONdevice, String url, RequestQueue queue)
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        Gson gson = new Gson();
                        JSONSwitch json = gson.fromJson(response, JSONSwitch.class);
                        Date currentTime = Calendar.getInstance().getTime();
                        float currenttime2 = currentTime.getHours()*3600 + currentTime.getMinutes()*60 + currentTime.getSeconds();
...
class LineChartXAxisValueFormatter_SwitchChart extends IndexAxisValueFormatter
{
