...
public class MainActivity_old extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    static public MainActivity_old I;
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //toanstt
       // ((TextView) findViewById(R.id.textbox_username)).setText("A123");

        Intent g2= new Intent(MainActivity_old.this, AppliancesActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        switch (id){
            ...
            case R.id.nav_home:
                Intent h= new Intent(MainActivity_old.this, MainActivity_old.class);
                h.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(h);
                break;
            case R.id.nav_device:
                Intent i= new Intent(MainActivity_old.this, DeviceScanActivityToan.class);
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(i);
                break;
            case R.id.nav_user:
                Intent g= new Intent(MainActivity_old.this,UserActivity.class);
