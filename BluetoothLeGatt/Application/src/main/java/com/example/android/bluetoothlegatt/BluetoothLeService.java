...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback()
    {
        ...
        {
            Log.d("KHUE4","onConnectionStateChange" );
            String intentAction;
        ...
        {
            Log.d("KHUE3","onServicesDiscovered" );
        ...
        {
            if(status == BluetoothGatt.GATT_SUCCESS)
                Log.d("KHUE5","onCharacteristicWrite SUCCESS: " + characteristic.getValue().toString());
            else Log.d("KHUE5","onCharacteristicWrite FAIL: " + characteristic.getValue().toString());
        }
        @Override
