 ...
 * Bluetooth LE API.
 */
public class DeviceControlActivityToan extends Activity {
    private final static String TAG = DeviceControlActivityToan.class.getSimpleName();
    public  static DeviceControlActivityToan I;
